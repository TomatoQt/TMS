...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            ...
            <form class="layui-form" action="buyToolApply" onsubmit="return checkPassword()">
                <input type="hidden" id="real_password" value="${sessionScope.user.password}">
                <div class="layui-form-item">
                    <label class="layui-form-label">选择类别</label>
                    <div class="layui-input-block">
                        <s:select name="ToolTypeId" list="list" listKey="id" listValue="name" headerKey="选择借用的工夹具"></s:select>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">采购数量</label>
                    <div class="layui-input-inline">
<%--                        <input type="text" name="title" required  lay-verify="required" placeholder="请输入需要的数量" autocomplete="off" class="layui-input">--%>
                    ...
                    <div class="layui-form-mid layui-word-aux">请选择采购数量</div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">密码</label>
                    <div class="layui-input-inline">
                        <s:password type="password" name="password" lay-verify="required" placeholder="请输入密码" autocomplete="off" class="layui-input"></s:password>
                    </div>
