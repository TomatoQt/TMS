        ...
        <div style="padding: 15px;">
            ...
            <table class="layui-table">
                ...
                <tr>
                    ...
                    <td>
                        <s:a class="layui-btn" href="PermitScrapManager_finalExamineOK?scrapid=%{id}">同意</s:a>
                        <s:a class="layui-btn layui-btn-danger" href="PermitScrapManager_finalExamineNO?scrapid=%{id}">驳回</s:a>
                    </td>
                </tr>
                </s:iterator>
                </tbody>
