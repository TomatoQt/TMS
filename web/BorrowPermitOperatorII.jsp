...
<%--            <s:form action="PermitBorrow" method="post">--%>
                    ...
                    <tbody>
                        <s:iterator value="list" status="sts">
                            <tr>
                                ...
                                <td>
                                    <s:a class="layui-btn" href="PermitBorrow?ioid=%{id}&status=pass1">同意</s:a>
                                    <s:a class="layui-btn layui-btn-danger" href="NotPermitBorrow?ioid=%{id}&status=no">驳回</s:a>
                                </td>
            <%--                    <td><s:property value="applicantId"/></td>--%>
            <%--                    <td><s:property value="toolId"/></td>--%>
            <%--                    <td>无</td>--%>
            <%--                    <td><s:property value="submit_time"/></td>--%>
            <%--                    <td>--%>
            <%--                        <button type="button" class="layui-btn" name="status" value="pass">同意</button>--%>
            <%--                        <button type="button" class="layui-btn layui-btn-danger" name="stauts" value="fail">驳回</button>--%>
            <%--                    </td>--%>
