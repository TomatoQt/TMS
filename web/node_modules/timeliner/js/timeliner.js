...
;(function($) {
        ...
        function startTimeliner(options){
            var settings = {
                ...
                fontOpen: options['fontOpen'] || '1.3em', // value: any valid CSS
                // font-size value, defaults to 1rem; sets the font
                ...
                expandAllText: options ['expandAllText'] || '+ 全部展开', // value:
                // string, sets the text of the expandAll selector
                // after the timeline is fully collapsed
                collapseAllText: options['collapseAllText'] || '- 全部折叠' // // value:
                // string, sets the text of the expandAll selector
